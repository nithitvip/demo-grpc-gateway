...
const (
	...
	BlogService_PartialUpdateBlog_FullMethodName = "/blog.v1.BlogService/PartialUpdateBlog"
	BlogService_DeleteBlog_FullMethodName        = "/blog.v1.BlogService/DeleteBlog"
	BlogService_ListBlog_FullMethodName          = "/blog.v1.BlogService/ListBlog"
)
...
func _BlogService_PartialUpdateBlog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(BlogServiceServer).PartialUpdateBlog(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var BlogService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PartialUpdateBlog",
			Handler:    _BlogService_PartialUpdateBlog_Handler,
		},
		{
